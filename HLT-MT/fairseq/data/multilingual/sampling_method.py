...
class SamplingMethod:
    ...
    def sampling_method_selector(self):
        ...
        if args.sampling_method == "uniform":
            ...
            return make_linear_temperature_sampling(float(args.sampling_temperature),
                                                    float(args.min_sampling_temperature), int(args.warmup_epoch))
        else:
            # default to concat all data set together
            return None
