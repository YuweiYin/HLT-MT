...
class CommonEvalConfig(FairseqDataclass):
    ...
    post_process: Optional[str] = field(
        default=None,
        metadata={
            "help": "post-process text by removing pre-processing such as BPE, letter segmentation, etc (valid "
                    "options are: sentencepiece, wordpiece, letter, _EOW, none, otherwise treated as BPE symbol)",
            "argparse_const": "@@ ",
...
class EvalLMConfig(FairseqDataclass):
    ...
    softmax_batch: int = field(
        default=sys.maxsize,
        metadata={
            "help": "if BxT is more than this, will batch the softmax over vocab to this amount of tokens, in order "
